...
const API = axios.create({
    baseURL: 'https://starmedia.herokuapp.com/api/'
})
...
export const getUserWithQuery = async(username) => await API.get(`/users?username=${username}`)
...
export const createConversation = async(receiverId) => await API.post(`/conversations/${receiverId}`)
export const getSingleConversation = async(conversationId) => await API.get(`/conversations/${conversationId}`)

export const getMessagesApi = async(convId) => await API.get(`/messages/${convId}`)
...
export const setMessageRead = async(messageId) => await API.patch(`/messages/${messageId}`)
export const setConversationMessageRead = async(conversationId) => await API.patch(`/messages/conversationMessageRead/${conversationId}`)